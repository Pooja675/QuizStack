// src/components/GenerateQuizWithAnswersPDF.jsx
import jsPDF from 'jspdf';
import 'jspdf-autotable';

export const generateQuizWithAnswersPDF = (quizData) => {
  const doc = new jsPDF();
  ...
  quizData.questions.forEach((q, idx) => {
    ...
    q.options.forEach((opt, optIdx) => {
      ...
      if (isCorrect) {
        doc.setTextColor(5, 150, 105);
        doc.text('✓', pageWidth - 20, yPosition);
      }
    ...
    doc.text(`✓ Correct Answer: ${correctLabel}. ${q.options[q.correctAnswer]}`, 17, yPosition + 6);
    yPosition += 15;
    ...
    if (q.explanation) {
      ...
      doc.setFont(undefined, 'bold');
      doc.setFontSize(9);
      doc.text('💡 Explanation:', 17, yPosition + 5);
      doc.setTextColor(0, 0, 0);
      doc.setFont(undefined, 'normal');
